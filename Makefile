...
OBJS = $(OBJ_DIR)/main.o $(OBJ_DIR)/frontend.o $(OBJ_DIR)/pak.o $(OBJ_DIR)/bass.o $(OBJ_DIR)/cpu.o $(OBJ_DIR)/arm.o $(OBJ_DIR)/bus.o $(OBJ_DIR)/ppu.o $(OBJ_DIR)/registers.o $(OBJ_DIR)/shifter.o $(OBJ_DIR)/arm_decode.o $(OBJ_DIR)/thumb_decode.o $(OBJ_DIR)/dma.o $(OBJ_DIR)/double_buffer.o 
CC=g++-13
# OBJS += $(OBJ_DIR)/sst.o 
...
final: $(OBJS) 
	@echo "linking...."
	$(CC) $(OBJS) $(OBJS_IMGUI) -o build/bin/$(PROJ_NAME) $(LD_FLAGS) $(sdl2-config --cflags --libs) -ldl
	chmod +x build/bin/$(PROJ_NAME)

$(OBJ_DIR)/main.o: src/main.cpp include/common.hpp
	$(CC) $(CPPFLAGS) -c src/main.cpp -o $(OBJ_DIR)/main.o

$(OBJ_DIR)/bass.o: src/core/bass.cpp include/core/bass.hpp src/core/bus.cpp include/core/bus.hpp
...
# 	$(CC) -g -O2 -c tests/sst_tests.cpp -DSST_TEST_MODE -DBASS_DEBUG -Ilib/ -Iinclude -Iinclude/core -Iinclude/common -std=c++23 -o $(OBJ_DIR)/sst.o -lspdlog -lpthread 
# 	$(CC) $(OBJS) $(OBJS_IMGUI)  -o build/bin/tests $(LD_FLAGS) -ldl
