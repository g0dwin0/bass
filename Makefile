...
OBJS = $(OBJ_DIR)/main.o $(OBJ_DIR)/frontend.o $(OBJ_DIR)/file_dialog.o $(OBJ_DIR)/cart.o $(OBJ_DIR)/mmu.o $(OBJ_DIR)/bass.o 
CC=g++
...
$(OBJ_DIR)/main.o: src/main.cpp include/common.hpp include/core/bass.hpp
	$(CC) $(CPPFLAGS) -c src/main.cpp -Ilib/cli11 -o $(OBJ_DIR)/main.o

$(OBJ_DIR)/bass.o: include/core/bass.hpp
	$(CC) $(CPPFLAGS) -c src/core/bass.cpp -Ilib/cli11 -o $(OBJ_DIR)/bass.o
...
$(OBJ_DIR)/mmu.o: src/core/mmu.cpp include/core/mmu.hpp
	$(CC) $(CPPFLAGS) -c src/core/mmu.cpp -o $(OBJ_DIR)/mmu.o
