...
InstructionInfo ARM7TDMI::arm_decode(InstructionInfo& instr) {
  ...
  if ((instr.opcode & 0xfb000f0) == 0x1200000) {  // MSR [register]
    ...
    instr.mnemonic = fmt::format("msr{} {}_{}{}{}{}, r{}", condition_map.at(instr.condition), instr.P == 0 ? "cpsr" : "spsr", modify_flag_field ? "f" : "", modify_status_field ? "s" : "",
                                 modify_extension_field ? "x" : "", modify_control_field ? "c" : "", +instr.Rm);
    return instr;
  }
  ...
  if ((instr.opcode & 0xe000090) == 0x10) {  // shift value is a register
    ...
    switch (o_opcode) {
      case AND: {
        instr.func_ptr = ARM::Instructions::AND;
        instr.mnemonic =
            fmt::format("and{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
      ...
      case EOR: {
        instr.func_ptr = ARM::Instructions::EOR;
        instr.mnemonic =
            fmt::format("eor{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case SUB: {
        instr.func_ptr = ARM::Instructions::SUB;
        instr.mnemonic =
            fmt::format("sub{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case RSB: {
        instr.func_ptr = ARM::Instructions::RSB;
        instr.mnemonic =
            fmt::format("rsb{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case ADD: {
        instr.func_ptr = ARM::Instructions::ADD;
        instr.mnemonic =
            fmt::format("add{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case ADC: {
        instr.func_ptr = ARM::Instructions::ADC;
        instr.mnemonic =
            fmt::format("adc{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case SBC: {
        instr.func_ptr = ARM::Instructions::SBC;
        instr.mnemonic =
            fmt::format("sbc{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case RSC: {
        instr.func_ptr = ARM::Instructions::RSC;
      ...
      case CMP: {
        instr.func_ptr = ARM::Instructions::CMP;
        instr.mnemonic =
            fmt::format("cmp{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        break;
      }
      case CMN: {
        instr.func_ptr = ARM::Instructions::CMN;
      ...
      case ORR: {
        instr.func_ptr = ARM::Instructions::ORR;
        instr.mnemonic =
            fmt::format("orr{}{} r{}, r{}, r{} {} r{} [{}]", instr.S ? "s" : "", condition_map.at(instr.condition), +instr.Rd, +instr.Rn, +instr.Rm, shift_string, +instr.Rs, shift_amount);
        // assert(0);
        break;
      }
      case MOV: {
